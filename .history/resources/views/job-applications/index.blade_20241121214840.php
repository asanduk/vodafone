                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-3 px-6 text-left">
                                            <div class="flex flex-col">
                                                <a href="{{ route('job-applications.show', $application->id) }}" class="text-blue-500 hover:underline mb-1">View Details</a>
                                                <span class="text-yellow-500 hover:underline mb-1" title="Edit">Edit</span>
                                                <button onclick="openModal({{ $application->id }})" class="text-red-500 hover:underline" title="Delete">Delete</button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
