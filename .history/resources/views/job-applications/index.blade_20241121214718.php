                            ...
                            <tbody class="text-gray-700 text-sm font-light">
                                @foreach($applications as $application)
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-3 px-6 text-left">
                                            <a href="{{ route('job-applications.show', $application->id) }}" class="text-blue-500 hover:underline">View Details</a>
                                            <span class="block text-yellow-500 hover:underline ml-4" title="Edit">
                                                Edit
                                            </span>
                                            <button onclick="openModal({{ $application->id }})" class="text-red-500 hover:underline ml-4" title="Delete">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
