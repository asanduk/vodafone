            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form action="{{ route('job-applications.store') }}" method="POST">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="applied_at" id="applied_at" class="form-control w-full" value="{{ old('applied_at') }}" required>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select name="status" id="status" class="form-control w-full">
                            ...
                            <option value="interview" {{ old('status') == 'interview' ? 'selected' : '' }}>Called for Interview</option>
                            <option value="rejected" {{ old('status') == 'rejected' ? 'selected' : '' }}>Rejected</option>
                            <option value="offered" {{ old('status') == 'offered' ? 'selected' : '' }}>Offer Received</option>
                        </select>
                    </div>
