            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('job-applications.update', $jobApplication->id) }}" method="POST">
                    ...
                    <div class="form-group mb-4 relative">
                        ...
                        <input type="text" name="position" id="position" class="form-control w-full" value="{{ $jobApplication->position }}" required maxlength="100" placeholder="Position name" onfocus="showTooltip('tooltip-position')" onblur="hideTooltip('tooltip-position')">
                    ...
                    <div class="form-group mb-4 relative">
                        ...
                        <input type="text" name="company_name" id="company_name" class="form-control w-full" value="{{ $jobApplication->company_name }}" required maxlength="100" placeholder="Company name" onfocus="showTooltip('tooltip-company')" onblur="hideTooltip('tooltip-company')">
