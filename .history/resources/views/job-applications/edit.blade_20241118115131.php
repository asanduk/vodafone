            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('job-applications.update', $jobApplication->id) }}" method="POST">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="tooltip" data-tooltip="Max 100 characters">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="tooltip" data-tooltip="Select the date you applied">
                            <small class="text-gray-500">Select the date you applied</small>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="tooltip" data-tooltip="Select the current status of your application">
                            <small class="text-gray-500">Select the current status of your application</small>
                        </div>
                    </div>
