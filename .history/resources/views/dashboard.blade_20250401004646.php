                        ...
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                            <div class="flex flex-col space-y-4">
                                ...
                                <div class="flex flex-col space-y-2">
                                    <button 
                                        class="statistics-tab px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300 active-tab text-left" 
                                        data-target="status-overview"
                                    >
                                        <i class="fas fa-chart-pie mr-2"></i>Übersicht
                                    </button>
                                    <button 
                                        class="statistics-tab px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300 text-left" 
                            ...
                            <div class="statistics-content mt-4">
                                ...
                                <div id="status-overview" class="statistics-panel">
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <a href="{{ route('contracts.index', ['category' => $category->id]) }}" 
                                           class="group p-3 bg-gray-50 rounded-lg hover:bg-red-50 transition-all duration-300 border border-gray-100 hover:border-red-200">
                                            <div class="flex items-center justify-between">
                                                <div>
                                                    <div class="text-gray-600 text-sm font-medium group-hover:text-red-600 transition-colors">{{ $category->name }}</div>
                                                    <div class="text-xl font-bold text-gray-800 group-hover:text-red-700">{{ $category->contracts_count }}</div>
                                                </div>
                                                <div class="p-2 bg-white rounded-full group-hover:bg-red-100 transition-colors">
                                                    <i class="fas fa-file-contract text-red-600 text-lg group-hover:text-red-700"></i>
                                                </div>
                                            </div>
                                        </a>
                                        @endforeach
                                ...
                                <div id="commission-stats" class="statistics-panel hidden">
                                    <div class="grid grid-cols-1 gap-3">
                                        ...
                                        <div class="bg-white rounded-lg p-3 border border-gray-100 hover:border-red-200 transition-all duration-300">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <div class="text-lg font-bold text-gray-800">{{ number_format($dailyCommission, 2) }}€</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-white rounded-lg p-3 border border-gray-100 hover:border-red-200 transition-all duration-300">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <div class="text-lg font-bold text-gray-800">{{ number_format($weeklyCommission, 2) }}€</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-white rounded-lg p-3 border border-gray-100 hover:border-red-200 transition-all duration-300">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <div class="text-lg font-bold text-gray-800">{{ number_format($monthlyCommission, 2) }}€</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-white rounded-lg p-3 border border-gray-100 hover:border-red-200 transition-all duration-300">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <div class="text-lg font-bold text-gray-800">{{ number_format($yearlyCommission, 2) }}€</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-white rounded-lg p-3 border border-gray-100 hover:border-red-200 transition-all duration-300">
                                            <div class="flex items-center">
                                                <div class="p-2 rounded-full bg-red-100">
                                                    <i class="fas fa-euro-sign text-red-600 text-lg"></i>
                                                </div>
                                                <div class="ml-3">
                                                    <div class="text-xs text-gray-500">Gesamtprovision</div>
                                                    <div class="text-lg font-bold text-gray-800">{{ number_format($totalCommission, 2) }}€</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="monthly-stats" class="statistics-panel hidden">
                                    <div id="monthlyStats" class="bg-white rounded-lg p-3 border border-gray-100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
