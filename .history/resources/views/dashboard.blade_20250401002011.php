                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-lg font-semibold">
                                    {{ number_format($todayStats['commission'], 2, ',', '.') }}€
                                </p>
                                <p class="text-xs text-gray-500">
                                    {{ $todayStats['count'] }} Verträge
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-lg font-semibold">
                                    {{ number_format($weekStats['commission'], 2, ',', '.') }}€
                                </p>
                                <p class="text-xs text-gray-500">
                                    {{ $weekStats['count'] }} Verträge
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-lg font-semibold">
                                    {{ number_format($monthStats['commission'], 2, ',', '.') }}€
                                </p>
                                <p class="text-xs text-gray-500">
                                    {{ $monthStats['count'] }} Verträge
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-lg font-semibold">
                                    {{ number_format($yearStats['commission'], 2, ',', '.') }}€
                                </p>
                                <p class="text-xs text-gray-500">
                                    {{ $yearStats['count'] }} Verträge
                                </p>
                            </div>
                        </div>
                    </div>
