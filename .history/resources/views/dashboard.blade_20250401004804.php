                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div class="bg-white rounded-lg p-6 border border-gray-200">
                                    <div class="flex items-center mb-4">
                                        ...
                                        <div class="mx-5">
                                            <h4 class="text-3xl font-semibold text-gray-700">{{ number_format($dailyCommission, 2) }}€</h4>
                                            <div class="text-gray-500">Heutige Provision</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white rounded-lg p-6 border border-gray-200">
                                    <div class="flex items-center mb-4">
                                        <div class="p-3 rounded-full bg-purple-600 bg-opacity-75">
                                            <i class="fas fa-calendar-week text-white fa-2x"></i>
                                        </div>
                                        <div class="mx-5">
                                            <h4 class="text-3xl font-semibold text-gray-700">{{ number_format($weeklyCommission, 2) }}€</h4>
                                            <div class="text-gray-500">Wöchentliche Provision</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white rounded-lg p-6 border border-gray-200">
                                    <div class="flex items-center mb-4">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="text-gray-500">Monatliche Provision</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white rounded-lg p-6 border border-gray-200">
                                    <div class="flex items-center mb-4">
                                        ...
                                        <div class="mx-5">
                                            <h4 class="text-3xl font-semibold text-gray-700">{{ number_format($yearlyCommission, 2) }}€</h4>
                                            <div class="text-gray-500">Jährliche Provision</div>
                                        </div>
                                    </div>
                                </div>
