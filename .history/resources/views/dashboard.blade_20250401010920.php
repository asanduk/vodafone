                        ...
                        <div id="commission-stats" class="statistics-panel">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                                <div class="bg-white p-4 rounded-lg shadow">
                                    <div class="text-sm text-gray-600">Tagesprovision</div>
                                    <div class="text-2xl font-bold text-red-600">{{ number_format($dailyCommission, 2) }}€</div>
                                </div>
                                <div class="bg-white p-4 rounded-lg shadow">
                                    <div class="text-sm text-gray-600">Wochenprovision</div>
                                    <div class="text-2xl font-bold text-red-600">{{ number_format($weeklyCommission, 2) }}€</div>
                                </div>
                                <div class="bg-white p-4 rounded-lg shadow">
                                    <div class="text-sm text-gray-600">Monatsprovision</div>
                                    <div class="text-2xl font-bold text-red-600">{{ number_format($monthlyCommission, 2) }}€</div>
                                </div>
                                <div class="bg-white p-4 rounded-lg shadow">
                                    <div class="text-sm text-gray-600">Jahresprovision</div>
                                    <div class="text-2xl font-bold text-red-600">{{ number_format($yearlyCommission, 2) }}€</div>
                                </div>
                            </div>

                            <div class="bg-white p-4 rounded-lg shadow">
                                <h3 class="text-lg font-semibold mb-4">Monatliche Übersicht</h3>
                                @if(count($monthlyData) > 0)
                                    <canvas id="monthlyChart"></canvas>
                                @else
                                    <div class="text-center text-gray-500 py-4">
                                        Keine Daten für die letzten 12 Monate verfügbar
                                    </div>
                                @endif
                            </div>
                        </div>
