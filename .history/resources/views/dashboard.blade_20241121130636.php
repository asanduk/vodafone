<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <p class="text-3xl font-bold text-blue-600">{{ $responseRate['response_rate'] }}%</p>
                    <p class="text-gray-500 text-sm">of applications received response</p>
                </div>

                <!-- Interview Rate Card -->
                <div class="bg-white rounded-lg shadow p-6">
                    <h3 class="text-lg font-semibold mb-2">Interview Rate</h3>
                    <p class="text-3xl font-bold text-green-600">{{ $responseRate['interview_rate'] }}%</p>
                    <p class="text-gray-500 text-sm">applications led to interview</p>
                </div>

                <!-- Average Response Time -->
                <div class="bg-white rounded-lg shadow p-6">
                    <h3 class="text-lg font-semibold mb-2">Avg. Response Time</h3>
                    <p class="text-3xl font-bold text-purple-600">{{ round($averageResponseTime) }} days</p>
                    <p class="text-gray-500 text-sm">until first response</p>
                </div>

                <!-- Success Rate -->
                <div class="bg-white rounded-lg shadow p-6">
                    <h3 class="text-lg font-semibold mb-2">Success Rate</h3>
                    <p class="text-3xl font-bold text-yellow-600">{{ $responseRate['success_rate'] }}%</p>
                    <p class="text-gray-500 text-sm">applications resulted in offer</p>
                </div>
            </div>
    ...
    <script>
        ...
        var statusOptions = {
            ...
            labels: ['Pending', 'Interview', 'Rejected', 'Offered'],
            colors: ['#fbbf24', '#3b82f6', '#ef4444', '#22c55e'],
            responsive: [{
                breakpoint: 480,
                options: {
                    chart: {
        ...
        var statusChart = new ApexCharts(document.querySelector("#statusDistribution"), statusOptions);
        statusChart.render();
    </script>
</x-app-layout>
