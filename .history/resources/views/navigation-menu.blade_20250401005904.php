        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-1 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="flex items-center px-4 py-2 text-red-700 hover:bg-red-50 rounded-md transition-colors duration-200">
                ...
                @if(auth()->user()->is_admin)
                    <div class="hidden space-x-1 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link href="{{ route('admin.categories.index') }}" :active="request()->routeIs('admin.categories.*')" class="flex items-center px-4 py-2 text-purple-700 hover:bg-purple-50 rounded-md transition-colors duration-200">
                            <i class="fas fa-cog text-purple-500 mr-2"></i>
                            <span>{{ __('Provision Verwaltung') }}</span>
                        </x-nav-link>
                        <x-nav-link href="{{ route('admin.users.index') }}" :active="request()->routeIs('admin.users.*')" class="flex items-center px-4 py-2 text-blue-700 hover:bg-blue-50 rounded-md transition-colors duration-200">
                            <i class="fas fa-users text-blue-500 mr-2"></i>
                            <span>{{ __('Benutzer Übersicht') }}</span>
                        </x-nav-link>
                    </div>
                @endif
            </div>
