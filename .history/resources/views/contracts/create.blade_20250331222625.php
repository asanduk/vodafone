    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            categorySelect.addEventListener('change', async function() {
                ...
                console.log('Kategori seçildi:', categoryId); // Debug log

                // Alt kategori seçeneğini sıfırla
                ...
                try {
                    ...
                    console.log('Alt kategoriler yüklendi:', subcategories); // Debug log
            ...
            subcategorySelect.addEventListener('change', async function() {
                ...
                try {
                    const response = await fetch(`/categories/${subcategoryId}/commission`);
                    const data = await response.json();
                    
                    // Komisyonu hesapla ve input'a yerleştir
                    const commission = (data.base_commission * data.commission_rate / 100).toFixed(2);
