                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" onclick="setToday()" class="absolute right-2 top-1/2 -translate-y-1/2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-2 py-1 rounded-md text-xs transition duration-150 ease-in-out">
                                        Heute
                                    </button>
                                </div>
                                @error('contract_date')
