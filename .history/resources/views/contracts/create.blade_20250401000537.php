<x-app-layout>
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center mb-8">
                        <div class="flex space-x-4">
                            <div class="w-8 h-8 rounded-full bg-red-600 text-white flex items-center justify-center font-bold">1</div>
                        ...
                        <div class="text-sm text-gray-500">Schritt 1 von 3</div>
                    </div>
                </div>
    ...
    <script>
        ...
        function updateStepIndicators(activeStep) {
            ...
            document.querySelector('.text-gray-500').textContent = `Schritt ${activeStep} von 3`;
        }

        // Mevcut JavaScript kodunuz (kategori ve komisyon hesaplama)
