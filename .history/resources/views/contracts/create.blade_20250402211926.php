    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            dateInput.addEventListener('change', function() {
                ...
                if (this.value === today) {
                    dateInfo.innerHTML = `
                        ...
                        <span>Heutiges Datum ist ausgewählt. Wenn Sie ein anderes Datum wünschen, wählen Sie bitte ein anderes Datum aus.</span>
                    `;
                } else {
                    dateInfo.innerHTML = `
                        <svg class="mr-1.5 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span>Ein anderes Datum wurde ausgewählt. Wenn Sie zum heutigen Datum zurückkehren möchten, wählen Sie bitte das heutige Datum aus.</span>
                    `;
                }
            });
            ...
            function setToday() {
                ...
                document.getElementById('contract_date').value = formattedDate;
            }
        });
    </script>
    @endpush
