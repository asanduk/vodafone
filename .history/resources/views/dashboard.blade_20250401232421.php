                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 mb-8">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <button 
                                class="statistics-tab px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300" 
                                data-target="competition-stats"
                            >
                                <i class="fas fa-trophy mr-2"></i>Wettbewerb
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="statistics-content">
                        ...
                        <!-- Wettbewerb Tab -->
                        <div id="competition-stats" class="statistics-panel hidden">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div class="bg-white rounded-lg p-6 border border-gray-100">
                                    ...
                                    <div class="space-y-4">
                                        @foreach($userRankings as $index => $user)
                                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-3">
                                                        ...
                                                        <div class="text-sm text-gray-500">{{ $user->total_contracts }} Verträge</div>
                                                    </div>
                                                </div>
                                                <div class="text-right">
                                                    <div class="font-bold text-red-600">{{ number_format($user->total_commission, 2) }}€</div>
                                                    <div class="text-sm text-gray-500">Ø {{ number_format($user->avg_commission, 2) }}€</div>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="bg-white rounded-lg p-6 border border-gray-100">
                                    <h4 class="text-lg font-semibold mb-4 flex items-center">
                                        ...
                                        Durchschnittswerte (3 Monate)
                                    </h4>
                                    <div class="space-y-4">
                                        <div class="p-4 bg-blue-50 rounded-lg">
                                            <div class="text-sm text-blue-600 mb-1">Durchschnittliche Provision pro Vertrag</div>
                                            <div class="text-2xl font-bold text-blue-700">{{ number_format($averageMetrics->avg_commission, 2) }}€</div>
                                        </div>
                                        <div class="p-4 bg-green-50 rounded-lg">
                                            <div class="text-sm text-green-600 mb-1">Durchschnittliche Verträge pro Monat</div>
                                            <div class="text-2xl font-bold text-green-700">{{ number_format($averageMetrics->avg_monthly_contracts, 1) }}</div>
                                        </div>
                                        <div class="p-4 bg-purple-50 rounded-lg">
                                            <div class="text-sm text-purple-600 mb-1">Durchschnittliche Monatsprovision</div>
                                            <div class="text-2xl font-bold text-purple-700">{{ number_format($averageMetrics->avg_commission * $averageMetrics->avg_monthly_contracts, 2) }}€</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
