                ...
                @foreach($mainCategories as $mainCategory)
                    <div class="mb-8">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-bold">{{ $mainCategory->name }}</h3>
                            <form action="{{ route('admin.categories.update', $mainCategory) }}" method="POST" class="flex items-center">
                                @csrf
                                @method('PUT')
                                <input type="number" 
