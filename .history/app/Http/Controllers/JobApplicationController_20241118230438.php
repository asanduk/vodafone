...
class JobApplicationController extends Controller
{
    ...
    // Aylara göre başvuru istatistiklerini alma
    public function getApplicationsStatistics()
    {
        $applicationsByMonth = JobApplication::select(DB::raw('MONTH(applied_at) as month, COUNT(*) as count'))
            ->groupBy('month')
            ->orderBy('month')
            ->pluck('count', 'month');

        return response()->json($applicationsByMonth);
    }
